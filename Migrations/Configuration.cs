    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BabyStore.DAL.StoreContext>
    {
        ...
        protected override void Seed(BabyStore.DAL.StoreContext context)
        {
            ...
            var products = new List<Product>
            {
                ...
                new Product { Name = "3 Pack of Bottles", Description="For a leak freedrink everytime", Price=24.99M, CategoryID=categories.Single( c =>c.Name == "Feeding").ID },
                ...
                new Product{Name = "Cot Bed", Description = "Converts from cot into bed forolder children", Price=149.99M, CategoryID=categories.Single( c =>c.Name == "Sleeping").ID},
                new Product{ Name = "Circus Crib Bale", Description = "Contains sheet, duvetand bumper", Price=29.99M, CategoryID=categories.Single( c => c.Name =="Sleeping").ID},
